...
Sebelum training, kita memastikan "bahan bakar" model ini bersih dan proporsional melalui standar **Crop-then-Resize**.
...
- **Hasil**: Menghilangkan fenomena "wajah gepeng/penyok" dan meningkatkan fokus model pada fitur wajah detail.
