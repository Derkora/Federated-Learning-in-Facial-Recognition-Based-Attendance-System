...
def process_equalization(src_dir, dest_dir, limit=40):
    ...
    print(f"Ndan, mulai meratakan data ke {limit} foto terbaik...")
    ...
    for folder in tqdm(folders):
        ...
        # Hitung skor blur untuk semua gambar di folder ini
        scored_images = []
        ...
        # Urutkan dari yang paling tajam (skor tertinggi)
    ...
    print(f"\nBeres, Komandan! Data sudah rata di folder: {dest_dir}")

if __name__ == "__main__":
    # Sesuaikan path dengan workspace Komandan
    SOURCE_DATA = "datasets"
    DEST_DATA = "datasets_equal"
    
    process_equalization(SOURCE_DATA, DEST_DATA, limit=40)