...
Dalam penelitian ini, \textit{Centralized Learning} diterapkan sebagai standar pembanding (\textit{baseline}) untuk mengevaluasi performa model MobileFaceNet, guna mengukur sejauh mana efektivitas dan akurasi yang dihasilkan oleh \textit{Federated Learning} dibandingkan dengan metode pelatihan tradisional tersebut.
